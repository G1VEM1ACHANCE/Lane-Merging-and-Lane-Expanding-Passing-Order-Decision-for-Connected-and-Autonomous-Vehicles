import loadV7
import input,scheduleV3,scheduleV4,scheduleV6
import sys
...
for i in range (30):
    ...
    start = time.time()
    allVeh,maxval,meanval,maxsched = scheduleV3.schedule_enter(allVeh,M)
    end = time.time()
    ...
    allVeh = input.deal_lane(allVeh,M,0)
    start = time.time()
    allVeh,maxval,meanval,maxsched = scheduleV6.schedule_enter(allVeh,M)
    end = time.time()
